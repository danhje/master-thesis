...
Tests for networks created by the CSA implementation in NEST, where 
both sources and targets are drawn randomly. 
'''
...
class NEST_RPCTester(RPCTester):
    ...
    def _connect(self):
        ...
        cs = csa.cset(csa.random(N=self._N) * finite_set)
...
class InDegreeTester(NEST_RPCTester):
    '''
    Tests for the in-degree distribution of networks created by the CSA
    implementation in NEST, where both sources and targets are drawn randomly.
    '''
...
class OutDegreeTester(NEST_RPCTester):
    '''
    Tests for the out-degree distribution of networks created by the CSA
    implementation in NEST, where both sources and targets are drawn randomly.
    '''
