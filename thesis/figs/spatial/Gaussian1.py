...
class ConnectLayers_tester(object):
    ...
    def ks_test(self, show_network=False, show_CDF=False,
        ...
        if show_CDF:
            ...
            a.arrow(0.5, 0.65, 0.0, 0.2, shape='full', head_width=0.03, head_length=0.05, 
            fc="k", ec="k", length_includes_head="True", lw=1)
        ...
        if show_PDF:
            ...
            #a.arrow(0.5, 0.45*2.5, 0.0, 0.2*2.5, shape='full', head_width=0.03, head_length=0.05*2.5, 
            #fc="k", ec="k", length_includes_head="True", lw=1)
...
if __name__ == "__main__":
    ...
    test = ConnectLayers_tester(L=1.0, N=100000, msd=0,
                                ...
                                function_params={'p_center': 1., 'sigma': 0.25,
                                                 'mean': 0., 'c': 0.})
