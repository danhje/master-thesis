...
class ConnectLayers3D_tester(object):
    ...
    def __init__(self, L, N, function_name, function_params=None,
        ...
        '''
        Initialize an ConnectLayers3D_tester object.
        ...
        if source_pos is None: source_pos = (0., 0., 0.)
    ...
    def ks_test(self, control=False, alternative='two_sided',
        ...
        if show_network:
            ...
            nodesize = 2 #max(1, int(round(111. / 11 - self.N / 11000.)))
...
if __name__ == "__main__":
    ...
    test = ConnectLayers3D_tester(L=1.0, N=50000, msd=0,
                                  function_name='gaussian',
                                  function_params={'sigma': 0.35})
